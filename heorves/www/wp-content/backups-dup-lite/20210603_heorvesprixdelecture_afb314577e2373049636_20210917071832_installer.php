...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210603_heorvesprixdelecture_afb314577e2373049636_20210917071832_archive.zip';
	const ARCHIVE_SIZE		 = '55110492';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'afb3145-17071832';
    const SECONDARY_PACKAGE_HASH = '20b904d-17071832';
	const VERSION			 = '1.4.3';
