...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210508_heorvesprixdelecture_ae45f0868566378a6404_20210516073003_archive.zip';
	const ARCHIVE_SIZE		 = '52323192';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ae45f08-16073003';
    const SECONDARY_PACKAGE_HASH = '17f7081-16073003';
	const VERSION			 = '1.4.0';
