...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210603_heorvesprixdelecture_559618b9683b43b82542_20210831075320_archive.zip';
	const ARCHIVE_SIZE		 = '65280986';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '559618b-31075320';
    const SECONDARY_PACKAGE_HASH = '496f606-31075320';
	const VERSION			 = '1.4.2';
