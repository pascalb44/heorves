...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210603_heorvesprixdelecture_ea08025219de477a8886_20210603092406_archive.zip';
	const ARCHIVE_SIZE		 = '58621088';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ea08025-03092406';
    const SECONDARY_PACKAGE_HASH = '10d5936-03092406';
	const VERSION			 = '1.4.1';
